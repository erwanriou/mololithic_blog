      ...
      <div className='layout'>
        <div className="opacity">
          <div className="container">
            <main>
              <div className="title">
                <h1><Translate id="register.title" /></h1>
                <h2><Translate id="register.subtitle" /></h2>
              </div>
              <div className="auth register">
                <a href='/auth/google' className="google">
                  <i className="fab fa-google-plus-g"></i>
                  <span><Translate id="register.google" /></span>
                </a>
                ...
                <span>
                  ...
                  <Link to='/login'><Translate id="register.login" /></Link>
                </span>
              </div>
            </main>
          </div>
